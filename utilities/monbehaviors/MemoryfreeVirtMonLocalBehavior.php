...
class MemoryfreeVirtMonLocalBehavior implements MonLocalBehaviorInterface{
    ...
    */
    public function execute($ovzStatistics,$warnvalue,$maxvalue){                
        ...
        && key_exists('memory_free_mb',$ovzStatistics['guest']['ram'])
        ){
            $value = $ovzStatistics['guest']['ram']['memory_free_mb'];
