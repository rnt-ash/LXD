                ...
                {% else %}
                    {% for monLocalJob in item.getMonLocalJobs() %}
                        ...
                        <tr class="{{ statusClass }}">
                            <td class="tableBtns">
                                {{ link_to("virtual_servers/monJobsEdit/"~monLocalJob.id,'<i class="fa fa-pencil"></i>',
                                    'class': 'btn btn-default btn-xs pending', 'data-toggle':'tooltip', 'data-placement':'top', 'title':_("monitoring_monjobs_edit")) }}
                                {{ link_to("virtual_servers/monJobsDiagram/"~monLocalJob.id,'<i class="fa fa-pie-chart"></i>',
                                ...
                                {% if monLocalJob.getMuted() == 0 %}
                                    <a href="#/" link="/virtual_servers/monJobsMute/{{monLocalJob.id}}" text="{{ _("monitoring_monjobs_muteconf") }}"
                                ...
                                {% else %}
                                    <a href="#/" link="/virtual_servers/monJobsMute/{{monLocalJob.id}}" text="{{ _("monitoring_monjobs_unmuteconf") }}"
                                ...
                                {% endif %}
                                <a href="#/" link="/virtual_servers/monJobsDelete/{{monLocalJob.id}}" text="{{ _("monitoring_monjobs_deleteconf") }}"
                            ...
                            <td>
                                <span title="ID: {{ monLocalJob.getId() }}" data-toggle="tooltip">
                                    {{ monLocalJob.getShortname('virtual') }}
                                </span>
                            </td>
                            <td>
            ...
            <table class="table table-striped table-condensed table-hover panel-sub-table">
                ...
                {% else %}
                    {% for monRemoteJob in item.getMonRemoteJobs() %}
                        ...
                        <tr class="{{ statusClass }}">
                            <td class="tableBtns">
                                {{ link_to("virtual_servers/monJobsEdit/"~monRemoteJob.id,'<i class="fa fa-pencil"></i>',
                                    'class': 'btn btn-default btn-xs pending', 'data-toggle':'tooltip', 'data-placement':'top', 'title':_("monitoring_monjobs_edit")) }}
                                {{ link_to("virtual_servers/monJobsDetails/"~monRemoteJob.id,'<i class="fa fa-list"></i>',
                                    'class': 'btn btn-default btn-xs', 'data-toggle':'tooltip', 'data-placement':'top', 'title':_("monitoring_monjobs_details")) }}
                                {% if monRemoteJob.getMuted() == 0 %}
                                    <a href="#/" link="/virtual_servers/monJobsMute/{{monRemoteJob.id}}" text="{{ _("monitoring_monjobs_muteconf") }}"
                                        class="btn btn-default btn-xs confirm-button pending" data-toggle="tooltip" title="{{ _("monitoring_monjobs_mute") }}"><i class="fa fa-volume-off"></i></a>
                                {% else %}
                                    <a href="#/" link="/virtual_servers/monJobsMute/{{monRemoteJob.id}}" text="{{ _("monitoring_monjobs_unmuteconf") }}"
                                        class="btn btn-default btn-xs confirm-button pending" data-toggle="tooltip" title="{{ _("monitoring_monjobs_unmute") }}"><i class="fa fa-volume-up"></i></a>
                                {% endif %}
                                <a href="#/" link="/virtual_servers/monJobsDelete/{{monRemoteJob.id}}" text="{{ _("monitoring_monjobs_deleteconf") }}"
                                    class="btn btn-default btn-xs confirm-button pending" data-toggle="tooltip" data-placement="top" title="{{ _("monitoring_monjobs_delete") }}"><i class="fa fa-trash-o"></i></a>
                            </td>
                            <td>
                                <span title="ID: {{ monRemoteJob.getId() }}" data-toggle="tooltip">
                                    {{ monRemoteJob.getShortname('virtual') }}
                                </span>
                            </td>
                            <td>
