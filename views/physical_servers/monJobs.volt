...
<div class="clearfix panel panel-{% if ok == true %}default{% else %}warning{% endif %} sub-panel">
    ...
    {% set state = slideSectionState(item.id,'PhysicalServersController','monjobs',defaultState) %}
    <div class="panel-heading">
        <span role="button" data-target="#slide_section_monjobs_{{item.id}}" onclick="toggleSectionState('slide_section_monjobs_{{item.id}}','physical_servers','{{defaultState}}',this)" data-toggle="collapse">
