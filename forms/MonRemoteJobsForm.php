...
class MonRemoteJobsForm extends \RNTForest\core\forms\FormBase
{
    public function initialize($monRemoteJob = null, $options = array())
    {
        // server id
        $this->add(new Hidden("server_id"));

        // behavior
        $message = self::translate("monitoring_monremotejobs_choose_behavior");
        $element = new Select(
            "mon_behavior_class",
            Monitoring::getRemoteBehaviors(),
            array("using"=>array("id","name"))
        );
        $message = self::translate("monitoring_monremotejobs_behavior");
        ...
        $message = self::translate("monitoring_monremotejobs_period");
        $element->setLabel($message);
        $message = $this->translate("monitoring_monremotejobs_period_placeholder");
        ...
        $message = self::translate("monitoring_monremotejobs_alarm_period");
        $element->setLabel($message);
        $message = $this->translate("monitoring_monremotejobs_alarm_period_placeholder");
        $element->setAttribute("placeholder",$message);
        $element->setFilters(array('int'));
        ...
        // get customer id of the server
        $server = $monRemoteJob->getServerClass()::findFirstById($monRemoteJob->getServerId());
        ...
        $message = self::translate("monitoring_monremotejobs_choose_message_contacts");
        $element = new Select(
        ...
        $message = self::translate("monitoring_monremotejobs_message_contacts");
        $element->setLabel($message);
        $element->setFilters(array('int'));
        ...
        // alarm contact
        $message = self::translate("monitoring_monremotejobs_choose_alarm_contacts");
        $element = new Select(
            "mon_contacts_alarm",
            $logins,
            array("using"=>array("id","name"),
        ...
        $message = self::translate("monitoring_monremotejobs_alarm_contacts");
        $element->setLabel($message);
        $element->setFilters(array('int'));
