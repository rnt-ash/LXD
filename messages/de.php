...
return [
    ...
    "colocations_edit" => "Einstellungen bearbeiten",
    ...
    "virtualserver_general_edit" => "Einstellungen bearbeiten",
    "virtualserver_general_deleteinfo" => "Sind Sie sicher, dass Sie diesen Virtuellen Server löschen wollen?",
